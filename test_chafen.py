...
# 3. 1和2的结果图像按位做“与”操作
# 视频文件输入初始化
filename = "/home/z840/dataset/UCF_Crimes/crop_out_30/test_video/Arson016_x264.mp4"
...
out1 = cv2.VideoWriter(os.path.join('/home/z840/dataset/UCF_Crimes/output/chafen', "{}_1.mp4".format(video_name)), fourcc, out_fps, (320, 240))
out2 = cv2.VideoWriter(os.path.join('/home/z840/dataset/UCF_Crimes/output/chafen', "{}_2.mp4".format(video_name)), fourcc, out_fps, (320, 240))
