...
def video_kmeans():
    ...
    with open("/home/z840/dataset/UCF_Crimes/Anomaly_Detection_splits/gt1.json", 'w') as f:
        for video_name in All_Folder:
            ...
            for item in txt_list:
                if video_name in item:
                    ...
                    if frame_start%16!=0:
                        gt1=[1]*math.ceil(frame_start/16)
                    ...
                    if frame_end==frame_lenth:
                        gt2=[0]*(sum_clip-math.ceil(frame_start/16))
                        anno_gt=gt1+gt2
                    if frame_end<frame_lenth and frame_end%16!=0:
                        gt3=[0]*(math.ceil(frame_end/16)-math.ceil(frame_start/16))
                        gt4=[1]*(sum_clip-math.ceil(frame_end/16))
                        anno_gt=gt1+gt3+gt4
                    if frame_start==-1:
                        anno_gt=[1]*sum_clip
