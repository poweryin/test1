...
video_list='/home/z840/dataset/UCF_Crimes/Eval_Res/'
# video_list='/home/z840/poweryin/GCN-Anomaly-Detection-master/c3d_features/c3d_iter_1000/'
out_path='/home/z840/dataset/UCF_Crimes/curve_MIL/'
...
# for video_name in dirs:
    video_path = os.path.join(video_list,video_name+'.mat')
    data=scio.loadmat(video_path)
    idx=data['begin_idx']
    scores=data['scores']
    score = []
    x_idx=[]
    ...
    for i in range(1):
        ...
        plt.savefig('/home/z840/dataset/UCF_Crimes/curve_MIL/{}_{}.jpg'.format(video_name, flag[i]))
        plt.close()
