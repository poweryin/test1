...
def niqe(inputImgData):
    ...
    params = scipy.io.loadmat('/home/z840/Downloads/niqe-master/data/niqe_image_params.mat')
...
if __name__ == "__main__":
    ...
    ref = np.array(Image.open('/home/z840/Downloads/niqe-master/test_imgs/bikes.bmp').convert('LA'))[:,:,0] # ref
    dis = np.array(Image.open('/home/z840/Downloads/niqe-master/test_imgs/bikes_distorted.bmp').convert('LA'))[:,:,0] # dis

    print('NIQE of ref bikes image is: %0.3f'% niqe(ref))
    print('NIQE of dis bikes image is: %0.3f'% niqe(dis))

    ref = np.array(Image.open('/home/z840/Downloads/niqe-master/test_imgs/parrots.bmp').convert('LA'))[:,:,0] # ref
    dis = np.array(Image.open('/home/z840/Downloads/niqe-master/test_imgs/parrots_distorted.bmp').convert('LA'))[:,:,0] # dis
