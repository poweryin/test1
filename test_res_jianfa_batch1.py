...
bg_path = "/home/z840/dataset/UCF_Crimes/crop_out_30/res_test/"
res_path = "/home/z840/dataset/UCF_Crimes/crop_out_30/res_test/"
result_path="/home/z840/dataset/UCF_Crimes/crop_out_30/test_res_diff/"
...
for video_name in All_Folder:
    ...
    for id in bg_folder:
        ...
        tmp_path=os.path.join(diffpath_, "{}".format(id))
        cv2.imwrite(os.path.join(diffpath_,"{}".format(id)), emptyimg)
