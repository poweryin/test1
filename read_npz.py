...
txt_list_file="/data/UCF_Crimes/Anomaly_Detection_splits/Temporal_Anomaly_Annotation.txt"
...
# for video_name in dirs:
    ...
    for i in range(length):
        ...
        avg_.append(transform(sum(scores[i])/10))
        tmp = sorted(scores[i])
