...
def addTextTOImage1(imageSrc, newImage,y):
    #
    image = Image.open(imageSrc)
    draw = ImageDraw.Draw(image)
    y2=y.split('.')[0]
    y1=int(y2)
    # font = ImageFont.truetype("C:\\WINDOWS\\Fonts\\SIMYOU.TTF", 20)
    # draw.text((5, 5), "Anomaly!!!", (255))
    draw.text((10, 10), "957:GT-Anomaly!!!", (75,200,86))
...
def npyLoad():
    ...
    labelPath = "/home/z840/dataset/UCF_Crimes/c3d_features_old/curve_txt/ind_test1.txt"
    videoPath = "/home/z840/dataset/UCF_Crimes/test_frames/"
    donePath = "/home/z840/dataset/UCF_Crimes/test_addtxt/"
    ...
    for item in txt_list:
        ...
        tmp=[0]*total_frames
        # ind_label[]
        x, y = ind_label.pop(0), ind_label.pop(0)
        flag = True
        for i in range(len(tmp)):
            if i >= x and i <= y:
                tmp[i] = 1
                flag = True
            elif i>y and flag and ind_label:
                x, y = ind_label.pop(0), ind_label.pop(0)
                flag = False
            else:
                pass
        ...
        # for x,y in enumerate(image):
            ...
            if x == 0:
                ...
                addTextTOImage1(image_, os.path.join(pathNew, y),y)
